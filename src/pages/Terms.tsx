            ...
            <div className="space-y-8 text-gray-700">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><strong>Recording of Calls:</strong> Calls with our AI-powered systems may be recorded to facilitate direct communication between Client and Recipient. In addition recordings may also be used for quality assurance, training and compliance purposes.</li>

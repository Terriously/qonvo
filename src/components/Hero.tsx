...
const Hero = () => {
  ...
  const professions = ["real estate", "tradies", "clinics"];
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center space-y-8 text-center">
          ...
          <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400 animate-fadeIn" style={{ animationDelay: "0.1s" }}>
            No more chasing cold leads. Provide 24/7 customer support. Get a natural Kiwi sounding AI phone assistant for your use case today.
          </p>
